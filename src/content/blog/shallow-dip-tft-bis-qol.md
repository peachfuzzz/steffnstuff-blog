...
> sidenote: i have a suspicion that this was relatively tricky to implement because of how much this stat changes by target. whatever tech they might have used to track crit chance with executioners from set 10 is probably responsible for this too
